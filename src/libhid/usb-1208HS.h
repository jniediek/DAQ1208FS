...
#define NCHAN            8         // max number of A/D channels in the device
#define NGAINS           4         // max number of gain levels (analog input)
#define NMODE            4         // max number of configuration modes
#define NCHAN_AO         4         // number of analog output channels

...
#define NCHAN  32                // max number of A/D channels in the device
#define NGAINS  9                // max number of gain levels (analog input)
...
void usbAOut_USB2416_4AO(usb_dev_handle *udev, int channel, double voltage, double table_A0[NCHAN_AO][2]);

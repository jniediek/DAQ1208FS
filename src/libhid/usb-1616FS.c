...
void usbBuildCalTable_USB1616FS(HIDInterface* hid, float table_AIN[NGAINS][NCHAN][2])
{
...
__s16 usbAIn_USB1616FS(HIDInterface* hid, __u8 channel, __u8 range, float table_AIN[NGAINS][NCHAN][2])
{
  __u16 data;
  __s16 value = 0.;
  __u8 report[3];
...
int usbAInScan_USB1616FS(HIDInterface* hid[], __u8 lowchannel, __u8 highchannel, __u32 nScan,
			 float *frequency, __u8 options, __s16 sdata[], float table_AIN[NGAINS][NCHAN][2], __u8 gainArray[16])
{
